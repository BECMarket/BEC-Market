    ...
    <!-- BARRA SECUNDARIA -->
      <div class="container">
        <nav class="nav nav-pills flex-column flex-sm-row mt-5 mx-auto" style="max-width: 500px;">
            ...
            <a class="flex-sm-fill text-sm-center nav-link bg-dark active" href="vendedor-productos.html">MIS PRODUCTOS</a>
            <a class="flex-sm-fill text-sm-center nav-link link-dark" href="vendedor-pedidos.html" style="background-color: #adb5bd;">PEDIDOS</a>
        </nav>
      </div>
    <!-- BARRA SECUNDARIA -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex flex-row bd-highlight justify-content-center mt-1 mb-3">
                    <a href="vendedor-nuevo-producto.html" class="link-success btn btn-outline-success btn-lg link-success"> <i class="fas fa-plus me-2"></i> Nuevo producto</a>
                </div>
            </div>
            <div class="col-md-6">
