...
<body>
    ...
    <div class="container">
        <nav class="nav nav-pills flex-column flex-sm-row mt-5 mx-auto" style="max-width: 250px;">            
            <a class="flex-sm-fill text-sm-center nav-link link-dark small" aria-current="page" style="background-color: #adb5bd;" href="cliente-mispedidos.html">EN CURSO</a>
            <a class="flex-sm-fill text-sm-center nav-link bg-dark active small" href="cliente-pedidos-historial.html">HISTORIAL</a>
        </nav>
    </div>
    <!-- TERCERA BARRA -->
